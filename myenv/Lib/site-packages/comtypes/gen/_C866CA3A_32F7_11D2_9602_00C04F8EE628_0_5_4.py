...
__all__ = [
    ...
    'DISPID_SVGetAudioOutputs', 'SECFDefault',
    '__MIDL_IWinTypes_0009', 'ISpeechLexiconWord',
    'SpeechStreamSeekPositionType', 'ISpeechRecoResultTimes',
    'SAFTNoAssignedFormat', 'DISPID_SpeechObjectTokens',
    'SREStreamEnd', 'STCLocalServer', 'DISPID_SVResume',
    'DISPID_SpeechRecoContext', 'SVP_17', 'SPEI_RECOGNITION',
    'SAFTGSM610_44kHzMono', 'DISPID_SPEDisplayAttributes',
    'SPCS_ENABLED', 'SRSEIsSpeaking', 'SPWORD', 'DISPID_SGRSTsCount',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRGId', 'ISpStreamFormat',
    'SREHypothesis', 'SAFTADPCM_11kHzMono', 'DISPID_SRGReset',
    'SAFT16kHz16BitMono', 'SVSFParseSsml', 'SpeechTokenValueCLSID',
    'DISPID_SRSSupportedLanguages', 'SSFMOpenForRead',
    'DISPID_SRCEPhraseStart', 'DISPID_SRCVoicePurgeEvent',
    'SITooSlow', 'SDTProperty', 'SVP_8', 'DISPID_SPAs_NewEnum',
    'DISPID_SPRNumberOfElements', 'SAFTADPCM_8kHzMono',
    'DISPID_SpeechMMSysAudio', 'DISPID_SPAsCount',
    'SAFT44kHz16BitStereo', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRCEBookmark', 'eLEXTYPE_RESERVED7',
    'DISPID_SPPConfidence', 'Speech_StreamPos_RealTime',
    'SGSExclusive', 'SpeechGrammarTagWildcard', 'SpeechMicTraining',
    'DISPID_SGRInitialState', 'SP_VISEME_12', 'SPEVENTSOURCEINFO',
    'SPRULE', 'SWTAdded', 'DISPID_SRRTTickCount',
    'DISPID_SpeechPhraseRules', 'SITooLoud',
    'SpeechDisplayAttributes', 'SITooQuiet',
    'DISPID_SRCRetainedAudio', 'DISPID_SASetState',
    'DISPID_SVEStreamStart', 'SVSFIsFilename', 'DISPID_SOTId',
    'DISPID_SPRuleConfidence', 'SRTEmulated', 'SPWT_DISPLAY',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpeechFileStream',
    'ISpMMSysAudio', 'SPAR_Unknown', 'DISPID_SPEEngineConfidence',
    'DISPID_SRGRules', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechObjectToken', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPIAudioSizeTime', 'SPEI_MAX_TTS', 'DISPID_SAFType',
    'SSSPTRelativeToStart', 'DISPID_SDKCreateKey', 'SSFMCreate',
    ...
    'DISPID_SGRAddState', 'DISPID_SGRSTWeight', 'SPAS_CLOSED',
    'SAFTCCITT_uLaw_11kHzMono', 'SRTStandard', 'DISPID_SPACommit',
    'DISPID_SOTCGetDataKey', 'SAFT8kHz16BitMono',
    'SVSFPurgeBeforeSpeak', 'SLTUser', 'DISPID_SVDisplayUI',
    'DISPID_SpeechPhoneConverter', 'DISPID_SOTCSetId', 'SP_VISEME_17',
    'DISPID_SVESentenceBoundary', 'SP_VISEME_10', 'DISPID_SGRSTsItem',
    'SPEI_UNDEFINED', 'DISPID_SPCPhoneToId', 'SASClosed',
    'STCInprocServer', 'SPCATEGORYTYPE', 'DISPID_SRAudioInputStream',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechTokenContext',
    'SPDATAKEYLOCATION', 'SPRECOSTATE',
    'SpeechRegistryLocalMachineRoot', 'ISpNotifySource',
    'eLEXTYPE_RESERVED10', 'SP_VISEME_3', 'SPEI_MIN_SR',
    'DISPID_SpeechObjectTokenCategory', 'SREBookmark', 'SGLexical',
    'DISPID_SpeechDataKey', 'SpeechRecoContextState',
    'SpeechVoiceSpeakFlags', 'DISPID_SRGetRecognizers', 'SRSActive',
    'DISPID_SRRAudio', 'SPPS_SuppressWord', 'SPDKL_DefaultLocation',
    'eLEXTYPE_PRIVATE3', 'DISPID_SVVoice', 'SpeechBookmarkOptions',
    'SAFT16kHz16BitStereo', 'SECFIgnoreKanaType',
    'DISPID_SpeechGrammarRuleState', 'SVSFParseAutodetect', 'SVP_1',
    'eLEXTYPE_PRIVATE13', 'DISPID_SRCEEnginePrivate',
    'DISPID_SCSBaseStream', 'DISPID_SGRSTransitions',
    'DISPID_SOTCEnumerateTokens', 'SGRSTTWord', 'SVEAudioLevel',
    'SpeechRunState', 'SPAS_RUN', 'eWORDTYPE_ADDED',
    'DISPID_SPEDisplayText', 'SAFT44kHz16BitMono', 'SVP_19',
    'SPEI_START_SR_STREAM', 'DISPID_SRRAudioFormat',
    'eLEXTYPE_RESERVED6', 'DISPID_SPIEngineId',
    'SAFT48kHz16BitStereo', 'SPRST_NUM_STATES', 'SPEI_RESERVED6',
    'DISPID_SPILanguageId', 'SPEI_ADAPTATION', 'DISPIDSPRG',
    'DISPID_SPIGetText', 'SPAO_RETAIN_AUDIO', 'SPFM_CREATE_ALWAYS',
    'SpeechInterference', 'SPPS_Function', 'SP_VISEME_18',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SOTs_NewEnum',
    'DISPID_SpeechVoice', 'SpAudioFormat',
    'DISPID_SPIGetDisplayAttributes', 'SPWORDPRONUNCIATIONLIST',
    'ISpeechCustomStream', 'eWORDTYPE_DELETED', 'SPINTERFERENCE',
    'DISPID_SPPChildren', 'ISpRecoContext2', 'SPPHRASEPROPERTY',
    'DISPID_SVSInputSentenceLength', 'DISPID_SpeechPhraseElements',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRCCreateGrammar',
    'ISpeechTextSelectionInformation', 'SVP_6', 'SAFT11kHz16BitMono',
    'SPVPRI_NORMAL', 'DISPID_SpeechAudioStatus', 'ISpObjectToken',
    'ISpeechDataKey', 'DISPID_SGRSTNextState',
    ...
    'ISpeechWaveFormatEx', 'SpeechUserTraining',
    'IInternetSecurityMgrSite', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPRST_INACTIVE', 'SAFTCCITT_ALaw_8kHzStereo', 'SPEI_SOUND_START',
    'DISPID_SGRsDynamic', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SDKOpenKey', 'SVP_12', 'SPGS_DISABLED', 'SPEI_PHONEME',
    'ISpRecoCategory', 'DISPID_SpeechLexiconWords', 'SP_VISEME_19',
    'DISPID_SPRules_NewEnum', 'SVSFIsNotXML',
    'SpeechEmulationCompareFlags', 'DISPID_SpeechWaveFormatEx',
    'SPXRO_SML', 'SpNotifyTranslator', 'ISpShortcut',
    ...
    'Speech_Max_Pron_Length', 'SRAORetainAudio', 'SVP_5',
    'SPAUDIOBUFFERINFO', 'DISPID_SDKGetBinaryValue',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SOTGetStorageFileName', 'SAFTCCITT_ALaw_11kHzMono',
    'SPLOADOPTIONS', 'SPGS_EXCLUSIVE', 'SAFT12kHz16BitStereo',
    ...
    'SRTExtendableParse', 'SREPrivate', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPEsCount', 'DISPID_SVGetProfiles', 'SVEVoiceChange',
    'SAFT44kHz8BitMono', 'SRAImport', 'DISPID_SpeechPhraseRule',
    'SVEWordBoundary', 'DISPID_SLPsCount', 'DISPID_SLWLangId',
    'SPPS_Noncontent', 'DISPID_SPEActualConfidence',
    'DISPID_SPRuleEngineConfidence', 'SGRSTTEpsilon',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPVISEMES',
    'DISPID_SOTsItem', 'SPFM_NUM_MODES', 'SREAllEvents',
    'eLEXTYPE_USER_SHORTCUT', 'SVPAlert', 'SRESoundEnd',
    'DISPID_SpeechAudioBufferInfo', 'SAFTText', 'ISpDataKey',
    'SVP_21', 'DISPID_SAFGetWaveFormatEx', 'ISpeechRecoGrammar',
    'DISPID_SpeechRecoResult2', 'SAFT12kHz8BitMono', 'UINT_PTR',
    'SpeechAudioState', 'SpeechAudioProperties',
    'DISPID_SpeechRecoResult', 'SPCT_SUB_COMMAND',
    'SPWORDPRONOUNCEABLE', 'SPGS_ENABLED', 'SAFT22kHz8BitMono',
    'SPEI_REQUEST_UI', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRRRecoContext', 'DISPID_SPRs_NewEnum',
    'SPADAPTATIONRELEVANCE', 'SPSNoun',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SPEs_NewEnum',
    'SPFM_CREATE', 'SREInterference', 'ISpeechRecoResult2',
    'SAFT8kHz16BitStereo', 'DISPID_SpeechRecoContextEvents',
    'SpeechRuleState', 'SPPS_RESERVED3', 'DISPID_SGRSTText',
    'ISpLexicon', 'SPVPRI_OVER', 'DISPID_SVAudioOutput',
    'SPLO_DYNAMIC', 'DISPID_SMSADeviceId',
    'DISPID_SPEAudioTimeOffset', 'SP_VISEME_7', 'SVESentenceBoundary',
    'SPEI_RESERVED1', 'SVSFNLPSpeakPunc', 'DISPID_SpeechGrammarRule',
    'WAVEFORMATEX', 'SPEI_PHRASE_START', 'DISPID_SLPSymbolic',
    'SAFT24kHz8BitStereo', 'SPSHT_Unknown', 'DISPID_SPRulesItem',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPAStartElementInResult',
    'ISpeechAudio', 'DISPID_SPRuleName', 'DISPID_SPRuleChildren',
    'SpeechCategoryRecoProfiles', 'SPWT_LEXICAL', 'SPWF_SRENGINE',
    'DISPID_SGRName', 'SPAS_STOP', 'SpeechAudioFormatType', 'SpVoice',
    'eLEXTYPE_APP', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRCCmdMaxAlternates', 'ISpAudio', 'SPAUDIOSTATUS',
    'DISPIDSPTSI_SelectionLength', 'SFTSREngine',
    'DISPID_SADefaultFormat', 'DISPID_SRRTLength',
    'DISPID_SVSLastBookmark', 'SAFTADPCM_22kHzMono', 'SPEVENTENUM',
    'SPEI_HYPOTHESIS', 'DISPID_SPPName', 'SBONone',
    'SRADefaultToActive', 'SPAS_PAUSE',
    'SpeechGrammarTagUnlimitedDictation', 'SPAR_High',
    'DISPID_SpeechAudio', 'SpeechAudioFormatGUIDText',
    'DISPID_SRSCurrentStreamNumber', 'SPBO_AHEAD',
    'DISPID_SPIAudioStreamPosition', 'SITooFast',
    'eLEXTYPE_RESERVED8', 'SVP_16', 'DISPID_SRCState',
    'DISPID_SRCEAudioLevel', 'DISPID_SWFEChannels', 'SPVPRI_ALERT',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SVSLastBookmarkId',
    'DISPID_SGRsAdd', 'SPPS_Verb', 'SRAONone', 'SPRECOGNIZERSTATUS',
    'SP_VISEME_0', 'STSF_FlagCreate', 'ISpeechPhraseAlternates',
    'DISPID_SRGCommit', 'DISPID_SPISaveToMemory', 'SVPOver',
    'DISPID_SRGSetTextSelection', 'eLEXTYPE_PRIVATE15',
    'ISpGrammarBuilder', 'ISpeechObjectTokenCategory',
    'SSFMCreateForWrite', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SPRsCount', 'SPEI_END_SR_STREAM', 'SpMemoryStream',
    'SVP_9', 'DISPID_SRAudioInput', 'eLEXTYPE_PRIVATE9',
    'tagSPPROPERTYINFO', 'SPFM_OPEN_READWRITE',
    'DISPID_SPEAudioSizeTime', 'DISPID_SDKGetStringValue',
    'SPSHORTCUTTYPE', 'SPBO_PAUSE', 'DISPID_SREmulateRecognition',
    'SPRS_ACTIVE', 'SAFT22kHz16BitMono', 'DISPID_SLGenerationId',
    'SPGRAMMARWORDTYPE', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPPsCount',
    'SRATopLevel', 'SLODynamic', 'SpeechRecoEvents',
    'SPSInterjection', 'DISPID_SRGState',
    'DISPID_SPRuleNumberOfElements', 'SPWORDLIST', 'SVP_0',
    'DISPID_SGRSTPropertyValue', 'SPSHT_EMAIL', 'SpWaveFormatEx',
    'DISPID_SPPNumberOfElements', 'SRCS_Disabled', 'SPPS_Unknown',
    'SP_VISEME_1', 'SPSFunction', 'SPAR_Low', 'DISPID_SMSAMMHandle',
    'SINoSignal', 'DISPID_SOTCDefault', 'SAFT32kHz8BitStereo',
    'SVEStartInputStream', 'ISpeechRecoResult', 'SPBO_NONE',
    'SSTTWildcard', 'DISPID_SRRSaveToMemory',
    'DISPID_SGRSTPropertyId', 'DISPID_SPPValue', 'SPPHRASERULE',
    'SpPhoneConverter', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SLPLangId', '_RemotableHandle',
    'SpeechPropertyAdaptationOn', 'DISPID_SLWType',
    'SPSMF_SAPI_PROPERTIES', 'SVP_10',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPPHRASEELEMENT',
    ...
    'SAFT32kHz8BitMono', 'SVF_Stressed', 'ISpeechPhraseRule',
    'SP_VISEME_9', 'SPAUDIOOPTIONS', 'SpInprocRecognizer',
    'SPEI_WORD_BOUNDARY', 'SP_VISEME_16', 'SpeechAudioFormatGUIDWave',
    'SpeechPropertyNormalConfidenceThreshold', 'SAFT24kHz8BitMono',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SWFESamplesPerSec',
    'SAFTADPCM_44kHzMono', 'ISpRecoResult',
    'DISPID_SGRsCommitAndSave', 'SPSEMANTICFORMAT',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SpeechLexicon', 'SpStream',
    'ISpObjectWithToken', 'ISpeechMMSysAudio',
    'DISPIDSPTSI_ActiveOffset', 'SPSHT_OTHER', 'SpeechGrammarState',
    'DISPID_SPIGrammarId', 'SBOPause', 'SSSPTRelativeToEnd',
    'DISPID_SVSPhonemeId', 'DISPID_SLWPronunciations',
    'SPEI_RESERVED2', 'SPRECORESULTTIMES', 'SPAO_NONE',
    'STSF_AppData', 'DISPID_SPPEngineConfidence',
    'SDA_No_Trailing_Space', 'SPEI_SR_PRIVATE', 'SPSUnknown',
    'DISPID_SRGDictationLoad', 'DISPID_SpeechAudioFormat',
    'DISPID_SLPPartOfSpeech', 'SpeechPropertyResponseSpeed',
    'SVSFIsXML', 'SpeechTokenKeyUI', 'DISPID_SFSOpen', 'SRARoot',
    'SPPROPERTYINFO', 'SAFTCCITT_uLaw_22kHzStereo', 'SVSFPersistXML',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpeechVisemeType',
    'ISpRecognizer3', 'SAFTGSM610_22kHzMono', 'DISPID_SBSWrite',
    'SPINTERFERENCE_NONE', 'DISPID_SBSFormat',
    'DISPID_SOTCreateInstance', 'DISPID_SVEStreamEnd',
    'SREFalseRecognition', 'SDTAlternates', 'DISPID_SRCEEndStream',
    'DISPID_SRCRequestedUIType', 'DISPID_SPEPronunciation',
    'SPSHT_NotOverriden', 'eLEXTYPE_PRIVATE12', 'DISPID_SPRuleId',
    'SpeechCategoryVoices', 'DISPID_SOTIsUISupported', 'SVP_3',
    'SAFT11kHz8BitStereo', 'DISPID_SPAsItem', 'Speech_StreamPos_Asap',
    'ISpeechRecognizer', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SWFEFormatTag', 'DISPID_SVEVoiceChange',
    'DISPID_SOTDisplayUI', 'DISPID_SRCEPropertyNumberChange',
    'SDTPronunciation', 'IEnumSpObjectTokens',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SREPhraseStart', 'SpeechCategoryAppLexicons',
    'DISPID_SLGetPronunciations', 'SpNullPhoneConverter',
    'SPEI_SR_RETAINEDAUDIO', 'SPBOOKMARKOPTIONS',
    'DISPID_SLWs_NewEnum', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SVSInputWordPosition', 'eLEXTYPE_RESERVED9',
    'DISPID_SVPriority', 'DISPID_SRCRetainedAudioFormat', 'SVP_18',
    'SP_VISEME_15', 'SP_VISEME_2', 'DISPID_SDKSetLongValue',
    'DISPID_SpeechRecoResultTimes', 'SPSMF_UPS', 'SPLEXICONTYPE',
    ...
    'SGDSInactive', 'SAFT11kHz8BitMono', 'eLEXTYPE_RESERVED4',
    'DISPID_SRGDictationSetState', 'SpObjectToken',
    'ISpeechPhraseElements', 'DISPID_SDKDeleteValue',
    'DISPID_SRSCurrentStreamPosition', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpeechAudioFormat', 'DISPID_SRProfile', 'DISPID_SABIEventBias',
    'ISpeechPhraseAlternate', 'SINone', 'SDTDisplayText',
    ...
    'DISPID_SpeechXMLRecoResult', 'DISPID_SLPPhoneIds',
    'DISPID_SGRs_NewEnum', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SBSRead',
    'DISPID_SPPFirstElement', 'SpMMAudioIn', 'SP_VISEME_8',
    'SpeechRecognizerState', '_SPAUDIOSTATE',
    'SAFTCCITT_ALaw_22kHzMono', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRCEFalseRecognition', 'DISPID_SOTGetDescription',
    'DISPID_SASState', 'SGRSTTRule', 'SpCustomStream',
    'SPRS_ACTIVE_USER_DELIMITED', 'SVP_11',
    'DISPID_SpeechCustomStream', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechDataKeyLocation', 'SVP_7', 'SECFIgnoreWidth',
    'DISPID_SOTSetId', 'SAFT8kHz8BitMono', 'SPXMLRESULTOPTIONS',
    'DISPID_SAEventHandle', 'ISpPhraseAlt', 'SPSTREAMFORMATTYPE',
    'DISPID_SPIRule', 'DISPID_SGRSTPropertyName', 'SRADynamic',
    'DISPID_SOTMatchesAttributes', 'DISPID_SpeechPhraseAlternate',
    'ISequentialStream', 'SPPS_Interjection', 'SPEVENT',
    'SAFT22kHz16BitStereo', 'SAFT22kHz8BitStereo',
    'DISPID_SLAddPronunciation', 'SPWF_INPUT', 'DISPID_SFSClose',
    'SVSFlagsAsync', 'DISPID_SpeechFileStream', 'ISpPhoneConverter',
    'DISPID_SLWsCount', 'SREAdaptation', 'LONG_PTR',
    'SPSNotOverriden', 'SAFT32kHz16BitStereo', 'DISPID_SPCLangId',
    'DISPID_SOTCId', 'SPPS_Modifier', 'SGDisplay',
    'DISPID_SVSVisemeId', 'SVP_14', 'SPRST_ACTIVE',
    'eLEXTYPE_PRIVATE1', 'SAFTADPCM_8kHzStereo', 'DISPID_SGRsItem',
    'SPSEMANTICERRORINFO', 'SP_VISEME_6', 'ISpeechPhraseReplacement',
    'SVSFParseSapi', 'DISPIDSPTSI_SelectionOffset',
    'SpeechRetainedAudioOptions', 'SpSharedRecognizer',
    'SAFT16kHz8BitStereo', 'SP_VISEME_13', 'ISpeechPhoneConverter',
    'SRAExport', 'SpeechAudioVolume', 'STCAll',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRGCmdLoadFromObject',
    'SPFM_OPEN_READONLY',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SRSInactiveWithPurge', 'SpeechStreamFileMode',
    'ISpeechRecoResultDispatch', 'DISPID_SPRFirstElement',
    'SpFileStream', 'ISpeechLexicon', 'SpeechLoadOption',
    'DISPID_SLRemovePronunciation', 'DISPID_SRGetPropertyNumber',
    'DISPID_SVSpeak', 'DISPID_SRRTStreamTime', 'SPAUDIOSTATE',
    'DISPID_SRCBookmark', 'SGDSActive', 'SPINTERFERENCE_TOOSLOW',
    'SpeechPartOfSpeech', 'DISPID_SVSkip',
    'SPRST_INACTIVE_WITH_PURGE', 'SPSERIALIZEDRESULT', 'SFTInput',
    'DISPID_SpeechPhraseAlternates', 'SVEEndInputStream',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPRS_INACTIVE',
    'DISPID_SpeechBaseStream', 'DISPID_SRCERequestUI',
    'SpCompressedLexicon', 'eLEXTYPE_PRIVATE20', 'SP_VISEME_11',
    'DISPID_SABIBufferSize', 'DISPID_SRState', 'SVF_Emphasis',
    'SVSFVoiceMask', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SDKGetlongValue', 'DISPID_SABIMinNotification',
    'SpeechAddRemoveWord', 'SVP_4', 'DISPID_SRRGetXMLErrorInfo',
    'ISpeechPhraseProperty', 'SECFEmulateResult',
    'ISpeechGrammarRule', 'SPSSuppressWord',
    'DISPID_SVEventInterests', 'DISPID_SOTRemove',
    'SPDKL_CurrentUser', 'DISPID_SPEsItem', 'SPTEXTSELECTIONINFO',
    'SpeechVoicePriority', 'SpeechRecognitionType',
    'SWPUnknownWordUnpronounceable', 'SPCS_DISABLED',
    'SPPS_RESERVED4', 'SPEI_START_INPUT_STREAM',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpUnCompressedLexicon',
    'ISpSerializeState', 'SWTDeleted', 'DISPID_SDKSetStringValue',
    'DISPID_SRIsUISupported', 'SpeechTokenShellFolder',
    'DISPID_SRDisplayUI', 'DISPID_SOTDataKey',
    'DISPID_SRCERecognitionForOtherContext', 'SPWT_PRONUNCIATION',
    'DISPID_SBSSeek', 'DISPID_SABufferNotifySize',
    'SPINTERFERENCE_TOOFAST', 'SPSLMA', 'SpMMAudioEnum',
    'SDKLLocalMachine', 'DISPID_SRCResume',
    'SpeechPropertyResourceUsage', 'SPSModifier', 'DISPID_SGRsCount',
    'DISPID_SRCEStartStream', 'DISPID_SLPType', 'SVP_2',
    'SpeechSpecialTransitionType', 'DISPID_SGRAttributes',
    'DISPID_SGRSAddWordTransition', 'DISPID_SMSSetData', 'SVP_15',
    'SP_VISEME_20', 'ISpeechLexiconPronunciation',
    'DISPID_SLPs_NewEnum', 'SAFTCCITT_ALaw_22kHzStereo',
    'SVSFDefault', 'DISPID_SRRecognizer', 'SPVPRIORITY', 'SRSEDone',
    'SPCT_SLEEP', 'DISPID_SRRGetXMLResult', 'ISpEventSource',
    'SPEI_RESERVED5', 'DISPID_SRCESoundEnd', 'SAFT8kHz8BitStereo',
    'ISpStream', 'DISPID_SpeechMemoryStream', 'DISPID_SPRText',
    'DISPID_SDKDeleteKey', 'SPPS_NotOverriden',
    'SpObjectTokenCategory', 'DISPID_SVSLastResult', 'SLOStatic',
    'SPSHORTCUTPAIR', 'SpeechRuleAttributes',
    'DISPID_SWFEBitsPerSample', 'DISPID_SWFEBlockAlign',
    'ISpProperties', 'SPEI_SOUND_END', 'DISPID_SPIReplacements',
    'SP_VISEME_14', 'SpeechWordPronounceable', 'SAFT12kHz16BitMono',
    'SAFT16kHz8BitMono', 'SPINTERFERENCE_TOOQUIET',
    'STSF_LocalAppData', 'SPDKL_LocalMachine', 'DISPID_SVEViseme',
    'SAFTCCITT_ALaw_11kHzStereo', 'SVEAllEvents',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRIsShared',
    'DISPID_SAFSetWaveFormatEx', '_ISpeechVoiceEvents',
    'SpeechRegistryUserRoot', 'DISPID_SOTCategory',
    'SDA_Two_Trailing_Spaces', 'ISpeechVoice',
    ...
    'SRTReSent', 'SpeechVisemeFeature', 'SVEViseme',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SAFTADPCM_11kHzStereo',
    'ISpeechPhraseElement', 'DISPID_SVSyncronousSpeakTimeout',
    'SVSFUnusedFlags', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPEI_TTS_PRIVATE', 'SPRULESTATE', 'SpShortcut', 'SRTSMLTimeout',
    'SPEI_SR_BOOKMARK', 'DISPID_SPPsItem', 'SpeechLexiconType',
    'ISpRecoGrammar', 'SPPHRASEREPLACEMENT', 'SDA_One_Trailing_Space',
    'eLEXTYPE_VENDORLEXICON', 'SPEI_MIN_TTS', 'SVP_20',
    'DISPID_SRSetPropertyNumber', 'DISPID_SVWaitUntilDone',
    'SPCONTEXTSTATE', 'SRSInactive', 'SGRSTTDictation',
    'SSTTTextBuffer', 'SAFTExtendedAudioFormat',
    'SPWORDPRONUNCIATION', 'DISPID_SPERequiredConfidence',
    'DISPID_SLGetGenerationChange', 'ISpVoice', 'ISpRecoGrammar2',
    'SPPS_Noun', 'Speech_Default_Weight', 'SpeechEngineProperties',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SMSGetData',
    'DISPID_SVVolume', 'SpTextSelectionInformation', 'SGSDisabled',
    'SRCS_Enabled', 'SPEI_END_INPUT_STREAM',
    'DISPID_SVEEnginePrivate', 'ISpeechRecognizerStatus',
    'SGDSActiveUserDelimited', 'DISPID_SGRSTType', 'SPCT_COMMAND',
    'SpPhraseInfoBuilder', 'SpeechRecoProfileProperties',
    'ISpeechVoiceStatus', 'DISPID_SRGCmdSetRuleState',
    'eLEXTYPE_PRIVATE14', 'SPINTERFERENCE_NOISE',
    'SpeechCategoryPhoneConverters', 'SpeechGrammarTagDictation',
    'eLEXTYPE_PRIVATE5', 'SRSActiveAlways', 'IStream',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SPRuleFirstElement',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpLexicon', 'SPPS_LMA',
    'SDKLCurrentConfig', 'DISPID_SGRClear', 'DISPID_SLGetWords',
    'SSTTDictation', 'SRAInterpreter', 'DISPID_SGRsFindRule',
    'DISPID_SPERetainedStreamOffset', 'ISpeechPhraseInfo', 'SPSVerb',
    'ISpeechXMLRecoResult', 'DISPID_SLWWord',
    'SPINTERFERENCE_NOSIGNAL', 'ISpeechPhraseRules', 'ISpRecognizer',
    'SPEI_MAX_SR', 'DISPID_SVSpeakStream', 'ISpNotifyTranslator',
    'SAFT44kHz8BitStereo', 'eLEXTYPE_PRIVATE8', 'STCInprocHandler',
    'DISPID_SpeechVoiceEvent', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRCEventInterests', 'ISpPhrase',
    ...
    'SpStreamFormatConverter', 'SpeechWordType', 'SAFT24kHz16BitMono',
    'SVF_None', 'SpeechCategoryAudioIn', 'DISPID_SRRAlternates',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPPParent',
    'SECHighConfidence', 'SPBO_TIME_UNITS', 'eLEXTYPE_PRIVATE10',
    'DISPID_SGRSTRule', 'SPSERIALIZEDPHRASE', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPCIdToPhone', 'DISPID_SpeechLexiconPronunciation',
    'SpSharedRecoContext', 'DISPID_SVSCurrentStreamNumber',
    'ISpXMLRecoResult', 'SASStop', 'DISPID_SRRPhraseInfo',
    'DISPID_SRCVoice', 'SPLO_STATIC', 'SLTApp', 'IEnumString',
    'DISPID_SRStatus', 'SVEBookmark', 'DISPID_SpeechLexiconProns',
    'SPPS_RESERVED2', 'SASPause', 'ISpRecoContext',
    'DISPID_SRCERecognizerStateChange', 'SPEI_RECO_STATE_CHANGE',
    'SDTAudio', 'DISPID_SVRate', 'ISpeechRecoContext',
    'DISPID_SRSAudioStatus', 'DISPID_SDKSetBinaryValue',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPEAudioSizeBytes',
    'SVEPrivate', 'DISPID_SGRId', 'SECLowConfidence',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SDKEnumKeys',
    'SDKLDefaultLocation', 'SpeechTokenIdUserLexicon',
    'SPEI_VOICE_CHANGE', 'SREPropertyNumChange', 'SPEI_VISEME',
    'ISpNotifySink', 'SPCT_SUB_DICTATION', 'SGRSTTWildcard',
    'tagSTATSTG', 'SpeechDiscardType', 'SGPronounciation',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SLWsItem',
    'ISpeechGrammarRules', 'Speech_Max_Word_Length',
    'ISpeechObjectTokens', 'SPSHORTCUTPAIRLIST',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SVEAudioLevel',
    ...
    'STCRemoteServer', 'SREPropertyStringChange', 'DISPID_SGRSRule',
    'SPGRAMMARSTATE', 'DISPID_SMSALineId',
    'SWPKnownWordPronounceable', 'DISPID_SPPId',
    'DISPID_SRCreateRecoContext', 'SREStreamStart',
    'DISPID_SGRAddResource', 'ISpeechPhraseReplacements',
    'DISPID_SGRsCommit', 'ISpeechBaseStream', 'ISpeechAudioStatus',
    'SVEPhoneme', 'DISPID_SRGetPropertyString',
    'DISPID_SRCRecognizer', 'DISPID_SRGDictationUnload',
    'DISPID_SVEPhoneme', 'ISpStreamFormatConverter',
    'SpeechCategoryAudioOut', 'DISPID_SVIsUISupported',
    'DISPID_SPAPhraseInfo', 'SPPHRASE', 'DISPID_SWFEAvgBytesPerSec',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SINoise',
    'SAFT48kHz16BitMono', 'SECFNoSpecialChars',
    'DISPID_SPIAudioSizeBytes', 'SDTRule', 'DISPID_SPRulesCount',
    'DISPID_SVAudioOutputStream', 'ISpeechObjectToken',
    'DISPID_SVStatus', 'DISPID_SRRDiscardResultInfo',
    'SAFT24kHz16BitStereo', 'SpeechTokenKeyAttributes',
    'SPINTERFERENCE_TOOLOUD', 'SPWORDTYPE',
    'DISPID_SRCEPropertyStringChange', 'SDTReplacement',
    'eLEXTYPE_USER', 'DISPID_SpeechPhraseInfo', 'DISPID_SVPause',
    'SVSFParseMask', 'SECFIgnoreCase', 'SAFT12kHz8BitStereo',
    'SpeechTokenKeyFiles', 'DISPID_SPELexicalForm',
    'DISPID_SOTGetAttribute', 'DISPID_SRGIsPronounceable',
    'SPAR_Medium', 'SVPNormal', 'ISpeechResourceLoader',
    'DISPID_SAFGuid', 'SpMMAudioOut', 'ISpeechLexiconPronunciations',
    'SRESoundStart', 'DISPID_SRSetPropertyString',
    'DISPID_SpeechPhraseReplacement', 'SREAudioLevel',
    'DISPID_SRRTimes', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpResourceManager', 'SPFILEMODE',
    'DISPID_SRCAudioInInterferenceStatus', 'SRERequestUI',
    'DISPID_SRCESoundStart', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SRGetFormat', 'SpeechPropertyLowConfidenceThreshold',
    'SVP_13', 'DISPID_SRRSpeakAudio',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRCEHypothesis',
    'SAFTCCITT_uLaw_44kHzMono', 'SDTLexicalForm',
    'ISpeechPhraseInfoBuilder', 'SPPS_RESERVED1',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRCEInterference',
    'DISPID_SRGRecoContext', 'SP_VISEME_21',
    'DISPID_SRSNumberOfActiveRules', 'eLEXTYPE_PRIVATE2',
    'ISpResourceManager', 'SPRECOCONTEXTSTATUS',
    'SAFTNonStandardFormat', 'SAFT11kHz16BitStereo',
    'SpeechAllElements', 'DISPID_SOTsCount', 'STSF_CommonAppData',
    'SpeechFormatType', 'SGRSTTTextBuffer',
    'DISPID_SRCSetAdaptationData', 'SGLexicalNoSpecialChars',
    'SAFT48kHz8BitStereo', 'SPXRO_Alternates_SML',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SREStateChange',
    'SPPARTOFSPEECH', 'SPBINARYGRAMMAR', 'eLEXTYPE_PRIVATE18',
    'DISPID_SGRSTs_NewEnum', 'DISPIDSPTSI', 'SVSFNLPMask',
    'SAFT32kHz16BitMono', 'DISPID_SRCPause', 'DISPID_SDKEnumValues',
    'SPDKL_CurrentConfig', 'eLEXTYPE_MORPHOLOGY', 'SPEI_RESERVED3',
    'DISPID_SVGetVoices', 'DISPID_SPIElements', 'DISPID_SAVolume',
    'DISPID_SLPsItem', 'SpeechVoiceEvents', 'SSFMOpenReadWrite',
    'DISPID_SASNonBlockingIO', 'SPCT_DICTATION',
    'DISPID_SPARecoResult', 'DISPID_SPIEnginePrivateData',
    'ISpeechLexiconWords', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SVEBookmark', 'DISPID_SRGCmdSetRuleIdState',
    'SECNormalConfidence', 'SDTAll', 'SAFTGSM610_11kHzMono',
    'SpeechVoiceSkipTypeSentence', 'SAFT48kHz8BitMono',
    'IInternetSecurityManager', 'ISpeechMemoryStream',
    'DISPID_SVGetAudioInputs', 'DISPID_SOTRemoveStorageFileName',
    'SASRun', 'eLEXTYPE_PRIVATE6', 'SRTAutopause',
    'eLEXTYPE_PRIVATE19', 'DISPID_SASFreeBufferSpace',
    'ISpObjectTokenCategory', 'eLEXTYPE_PRIVATE17',
    'DISPID_SVSRunningState', 'SP_VISEME_5', 'SPEI_TTS_BOOKMARK',
